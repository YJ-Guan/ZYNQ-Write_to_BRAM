...
HD_PWD='G:/Write_to_BRAM/Write_to_BRAM/Write_to_BRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Write_to_BRAM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Write_to_BRAM_wrapper.tcl
