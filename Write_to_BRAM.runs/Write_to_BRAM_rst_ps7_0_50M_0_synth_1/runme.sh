...
HD_PWD='G:/Write_to_BRAM/Write_to_BRAM/Write_to_BRAM.runs/Write_to_BRAM_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Write_to_BRAM_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Write_to_BRAM_rst_ps7_0_50M_0.tcl
