...
HD_PWD='G:/Write_to_BRAM/Write_to_BRAM/Write_to_BRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Write_to_BRAM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Write_to_BRAM_wrapper.tcl -notrace
