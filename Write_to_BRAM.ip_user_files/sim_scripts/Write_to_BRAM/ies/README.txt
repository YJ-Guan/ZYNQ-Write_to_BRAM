...
#
# Generated by export_simulation on Tue Jan 19 20:08:46 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Write_to_BRAM.sh' script.

./Write_to_BRAM.sh -reset_run
...
./Write_to_BRAM.sh -noclean_files

For more information on the script, please type './Write_to_BRAM.sh -help'.
