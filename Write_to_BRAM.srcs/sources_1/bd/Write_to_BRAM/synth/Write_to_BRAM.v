...
(* CORE_GENERATION_INFO = "Write_to_BRAM,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Write_to_BRAM,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_bram_cntlr_cnt=3,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Write_to_BRAM.hwdef" *) 
module Write_to_BRAM
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.RBRAM_INTERRUPT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.RBRAM_INTERRUPT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) input rbram_interrupt;
  ...
  wire [18:0]axi_smc_M01_AXI_ARADDR;
  ...
  wire [18:0]axi_smc_M01_AXI_AWADDR;
  ...
  wire rbram_interrupt_1;
  wire [0:0]rst_ps7_0_50M_peripheral_aresetn;

  assign rbram_interrupt_1 = rbram_interrupt;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > Write_to_BRAM blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Write_to_BRAM_axi_bram_ctrl_0_1 axi_bram_ctrl_1
