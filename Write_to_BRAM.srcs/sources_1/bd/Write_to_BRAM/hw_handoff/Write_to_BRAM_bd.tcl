...
################################################################
# This is a generated script based on design: Write_to_BRAM
#
...
# source Write_to_BRAM_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set rbram_interrupt [ create_bd_port -dir I -type intr rbram_interrupt ]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rbram_interrupt_1 [get_bd_ports rbram_interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  assign_bd_address -offset 0x50000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
